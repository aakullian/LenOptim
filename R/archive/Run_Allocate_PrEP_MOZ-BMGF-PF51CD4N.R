...
source("Allocate_PreP_MOZ_v2_district_priority.R", echo=F) #Load model functions
...
#Write outputs
write.csv(outputs$result_df, "MOZ_OUTPUT/result_df_district_prioritization_2.csv", row.names = FALSE, na = "")
