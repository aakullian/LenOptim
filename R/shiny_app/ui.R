          ...
          fluidRow(
            column(10, offset = 1,
              ...
              p(style = "font-size: 15px; line-height: 1.7;",
                ...
                "it determines which districts by (age-group, sex, and risk strata) should receive ",
              ...
              tags$ul(style = "font-size: 13px; line-height: 1.8;",
                ...
                tags$li("Set number of risk groups (from low to high risk) within a district (1 = district average, 4 or 8 = finer risk targeting). ",
                        "Then use the slider to restrict allocation to only the highest-risk percentiles within a district if desired. Note, restricting to the highest-risk quantiles may lead to sub-optimal allocation if lower risk groups in high incidence districts are excluded."),
              ...
              p(style = "font-size: 13px; line-height: 1.7;",
                "For details on the model, data sources, and methodology, see the ",
                tags$strong("Model Details"), " tab."
              ),
          ...
          fluidRow(
            column(10, offset = 1,
              ...
              p(style = "font-size: 14px; line-height: 1.7;",
                "This model estimates the short-term, direct impact of HIV PrEP. ",
                "It does not include transmission dynamics and therefore does not capture secondary infections averted, ",
                "including mother-to-child transmissions."
              ),
              ...
              tags$p(style = "font-size: 14px; font-weight: bold;", "Notes on Parameters"),
              p(style = "font-size: 13px; line-height: 1.7;",
